...
Если $m_{h}$ - минимальное число вершин в AVL-дереве высоты h. Тогда как легко видеть, $m_{h + 2} = m_{h + 1} + m_{h} + 1$. Равенство $m_{h} = F_{h + 2} - 1$ докажем по индукции. 
...
![[Pasted image 20230818175715.png]]
